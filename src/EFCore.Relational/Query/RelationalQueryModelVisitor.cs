...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    public class RelationalQueryModelVisitor : EntityQueryModelVisitor
    {
        ...
        private readonly Dictionary<JoinClause, Tuple<GroupJoinClause, AdditionalFromClause>> _flattenedGroupJoinClausesMapping = new Dictionary<JoinClause, Tuple<GroupJoinClause, AdditionalFromClause>>();
