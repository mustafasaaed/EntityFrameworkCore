...
namespace Microsoft.EntityFrameworkCore.Query.Internal
{
    ...
    ///     directly from your code. This API may change or be removed in future releases.
    /// </summary>
    public struct AnonymousObject2
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
            ...
            out QuerySourceReferenceExpression querySourceReferenceExpression)
        {
            ...
            if (methodCallExpression.Object?.Type == typeof(AnonymousObject2)
                && methodCallExpression.Method.Equals(GetValueMethodInfo)
                && methodCallExpression.Object is QuerySourceReferenceExpression qsre)
            {
                querySourceReferenceExpression = qsre;
        ...
        /// </summary>
        public static readonly ConstructorInfo AnonymousObjectCtor
            = typeof(AnonymousObject2).GetTypeInfo()
                .DeclaredConstructors
                .Single(c => c.GetParameters().Length == 1);
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static bool operator ==(AnonymousObject2 x, AnonymousObject2 y) => x.Equals(y);
        ...
        /// </summary>
        [UsedImplicitly]
        public AnonymousObject2([NotNull] object[] values) => _values = values;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is AnonymousObject2 anonymousObject
                   && _values.SequenceEqual(anonymousObject._values);
        }
